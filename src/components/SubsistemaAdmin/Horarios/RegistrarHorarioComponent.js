        ...
        <>
            ...
            <Modal isOpen = {insert}>
                ...
                <ModalBody>
                    ...
                    <div className="docenteambsem">{'El semestre es:'} {' '} {s}</div>
                    <FormGroup>
                        <Label>GRUPO:</Label>
                    ...
                    <div className="docenteambsem">{'El grupo es:'} {' '} {g}</div>
                    <FormGroup>
                        <Label>DIA:</Label>
                    ...
                    <div className="docenteambsem">{'El o la docente es:'} {' '} {nombre} {' '} {ap_paterno} {' '} {ap_materno}</div>
                    <FormGroup>
                    ...
                    <div className="docenteambsem">{'El ambiente es:'} {' '} {a}</div>
                    <FormGroup>
                        <Label>PISO:</Label>
                    ...
                    <div className="docenteambsem">{'El piso es:'} {' '} {p}</div>
                    <FormGroup>
